...
class PublicLeagues extends StatelessWidget {
  const PublicLeagues({
    Key? key,
  }) : super(key: key);
      ...
      child: Column(
        ...
        children: [
          ...
          FutureBuilder<List<LeagueModel>>(
              future: Get.find<LeagueController>().fetchPublic(),
                        ...
                        ...snapshot.data!.map<Widget>((e) => Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              TextButton(onPressed: () => _joinPublic(code: e.code, id: e.id) , child: Text("Join League", style: GoogleFonts.mulish(color: AppTheme.purple),)),
                            ],
                          ),
                        ))
                      ],
  ...
  void _joinPublic({required int id,required String code}){
    final data = {
      "id": id,
      "code": code
    };
